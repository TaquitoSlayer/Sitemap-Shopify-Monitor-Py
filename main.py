    ...
    with open('webhook.json') as json_file:
        ...
        for site_name in json_dump:
            if site_name in result:
                ...
                webhookz = ['https://discordapp.com/api/webhooks/555789296431267875/WqiqWrb6KJQ3ZwS9-jJyxgglrIwxRGfPO2_i_L5xxmUy0UZx8bDNlfGwXYF-j19YASAs']
                embed = Embed()
                for webhook in webhookz:
                    ...
                    embed.set_footer(text=f'Shopify Monitor (XML) by @TaquitoSlayer | {result}')
